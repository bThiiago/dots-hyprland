...
`,
  ...
  },
  {
    role: "assistant",
    content:
      "Got it! I'll try to give commands to perform Linux tasks. I'll try to use markdown features extensively, use divider when appropriate, and use a heading for code blocks. All code blocks should use 2 spaces for indent. And most importantly, I'll speak naturally.",
    thinking: false,
    done: true,
  },
];
...
class ChatGPTService extends Service {
  ...
  send(msg) {
    ...
    this.emit("newMsg", this._messages.length - 1);
    const aiResponse = new ChatGPTMessage(
      "assistant",
      "thinking...",
      true,
      false
